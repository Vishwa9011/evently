    ...
    <>
      <section className="flex justify-center bg-primary-50 bg-dotted-pattern bg-contain">
        <div className="grid grid-cols-1 md:grid-cols-2 2xl:max-w-7xl">
          <Image src={event.imageUrl} alt="hero image" width={1000} height={1000} className="h-ful min-h-[300px] object-cover object-center" />
          <div className="flex w-full flex-col gap-8 p-5 md:p-10">
            ...
            <div className="flex flex-col gap-3">
              ...
              <p className="p-medium-16 lg:p-p-regular-20">{event.description}</p>
              <p className="p-medium-16 lg:p-p-regular-20 truncate text-primary-500 underline">{event.url}</p>
            </div>
          </div>
        </div>
      </section>
