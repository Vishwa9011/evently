    ...
    <Select onValueChange={onChangeHandler} defaultValue={value}>
      ...
      <SelectContent>
        {categories.length > 0 && categories.map(categories => (
          <SelectItem key={categories._id} value={categories._id} className='select-item p-regular-14'>
            {categories.name}
          </SelectItem>
        ))}
          ...
          <AlertDialogContent className="bg-white">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                <Input type="text" placeholder="Category name" value={newCategory} className="input-field mt-3" onChange={e => setNewCategory(e.target.value)} />
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
